...
void lv_port_disp_init(void)
{
    ...
    static lv_color_t buf_2[MY_DISP_HOR_RES * 160]; 

    lv_disp_draw_buf_init(&draw_buf_dsc_1, buf_1, buf_2, MY_DISP_HOR_RES * 160); /*Initialize the display buffer*/
    /*-----------------------------------
